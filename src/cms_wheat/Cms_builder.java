...
*/
		...
		tmpDemandAdjustedForPeriodicity.add(new Integer((int)(1.00*(tmpFoodDemandComponentAdjustedForPeriodicity.get(0)+tmpOtherDemandComponentsAdjustedForPeriodicity.get(0)))));
