...
*/
		...
		tmpDemandAdjustedForPeriodicity.add(new Integer((int)(0.97*(tmpFoodDemandComponentAdjustedForPeriodicity.get(0)+tmpOtherDemandComponentsAdjustedForPeriodicity.get(0)))));
